...
namespace edge_net{
  void edge_network_s(input_t input_1[N_INPUT_1_1], result_t layer7_out[N_LAYER_6]);
}
...
void edge_network_s(input_t input_1[N_INPUT_1_1], result_t layer7_out[N_LAYER_6]) {
    ...
    nnet::sigmoid<layer6_t, result_t, Sigmoid_config7>(layer6_out, layer7_out); // _2_block_1
