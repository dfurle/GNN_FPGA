...
int main(int argc, char **argv) {
    ...
    if (fin.is_open() && fpr.is_open()) {
      ...
      nnet::copy_data<float, input_t, 0, N_INPUT_1_1>(in, dense_edge_1_input);
      result_t layer9_out[N_LAYER_8];

            // hls-fpga-machine-learning insert top-level-function
            myproject(dense_edge_1_input,layer9_out);
    ...
    input_t dense_edge_1_input[N_INPUT_1_1];
    nnet::fill_zero<input_t, N_INPUT_1_1>(dense_edge_1_input);
    result_t layer9_out[N_LAYER_8];
